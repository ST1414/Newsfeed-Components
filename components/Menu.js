...
function menuMaker (menuItems){
  ...
  const button = document.querySelector('.menu-button'); // STEP 3
  
  button.addEventListener('click', () => { // STEP 4
    menu.classList.toggle('menu--open'); // REMEMBER!!! ON CLASS LIST, DONT NEED PERIOD
  });
